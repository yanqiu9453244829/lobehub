...
import { resolveWechatQrImageSource, WechatQrSetup } from './Wechat';
...
describe('resolveWechatQrImageSource', () => {
  it.each([
    ['data:image/png;base64,abc', 'data:image/png;base64,abc'],
    ['https://weixin.qq.com/x/qr-code', 'https://weixin.qq.com/x/qr-code'],
    ['  raw-base64  ', 'data:image/png;base64,raw-base64'],
  ])('normalizes %s', (input, expected) => {
    expect(resolveWechatQrImageSource(input)).toBe(expected);
  });
});
